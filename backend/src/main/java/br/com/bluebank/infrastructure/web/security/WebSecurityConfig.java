    ...
    protected void configure(HttpSecurity http) throws Exception 
    {
        ...
        .and()
            .authorizeRequests()
                ...
                .antMatchers("/api/server/default-response/public").permitAll()
                .antMatchers("/api/user/account/deposit").permitAll()
                .antMatchers("/api/account/fetchFavoredName/*").permitAll()
